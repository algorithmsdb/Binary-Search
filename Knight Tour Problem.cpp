...
void printSolution(int sol[N][N])
{
    ...
    {
        for (int y = 0; y < N; y++)
            printf(" %2d ", sol[x][y]);  //"Minimum number of characters to be printed. If the value to be printed is shorter than this number,
                                         // the result is padded with blanks. The value is never truncated even if the result is larger."
        printf("\n");
    }
}
